...
model=arg1.model;graphics=arg1.graphics;label=graphics.exprs
  ...
  while %t do
    [ok,typ,decomptyp,lab]=getvalue('Set MATSVD block parameters',['Datatype(1=real double  2=Complex)';'Decomposition type (1=singular values  2=singular values+matrix U & V)'],list('vec',1,'vec',1),label)
