...
case 'set' then
  ...
  model=arg1.model;
  while %t do
    [ok,L,D,lambda,z1,z2,p_rho,exprs]=getvalue('Thermal-hydraulic pipe parameters', ..
     ['Length of pipe: L (m)';..
      'Pipe diameter: D (m)';..
      'Coefficient of thermohydraluc resistance: lambda';..
      'Altitude of the first port: z1 (m)';..
      'Altitude of the second port: z2 (m)';..
      'Fluid density: p_rho (kg/m3)'],..
