function [nok,a_domaine,b_domaine,discr,signe,choix,type_meth,degre,Nbr_maillage,..
  ...
  txt4 = uicontrol(f, "Position",[20 530 60+120 15],"Style","text","String","Spécification de l''EDP",...
  ...
  txt81 = uicontrol(f, "Position",[25 220 40+180 15],"Style","text","String","Méthode de discrétisation spatiale",...
     "fontsize",2+10,"BackgroundColor",[0.9 0.9 0.9]);
  ...
  editordre3 = uicontrol(f, "Position"  , [270 157.5 15 15],"Style","edit","String",params_pde.ord3,...
  		 "BackgroundColor",[1 1 1]);		
  // Degre		 
  txt84 = uicontrol(f, "Position",[320 200 70 15],"Style","text","String","degré :","fontsize",2+10,...
  		 "BackgroundColor",[0.9 0.9 0.9]);
