...
//----------------------------------------------------------------------- ---//  
  ...
  [a1_ev,a2_ev,a3_ev,a4_ev,a5_ev,a6_ev,a7_]=eval_a(xn,a1,a2,a3,a4,a5,a6,a7) 
  ...
  if ((find(oper == 2) ==[]) & (find(oper == 4) ==[]) ) then
    ...
    // cas oper2 ou oper4
//RN    if (find(oper == 2) ~=[] ) then
    if (find(oper == 2) ~=[] | find(oper == 4) ~=[] ) then  //RN
...
function [%a1_ev,%a2_ev,%a3_ev,%a4_ev,%a5_ev,%a6_ev,%a7_ev]=eval_a(%xn,%a1,%a2,%a3,%a4,%a5,%a6,%a7)
  ...
  for i=1:size(xn,1)
    x=xn(i);
    a1_=evstr(%a1); a2_=evstr(%a2); a3_=evstr(%a3);
    a4_=evstr(%a4); a5_=evstr(%a5); a6_=evstr(%a6); 
    a7_=evstr(%a7);
    %a1_ev(i)=a1_; %a2_ev(i)=a2_; %a3_ev(i)=a3_;
    %a4_ev(i)=a4_; %a5_ev(i)=a5_; %a6_ev(i)=a6_; 
    %a7_ev(i)=a7_;
  end
