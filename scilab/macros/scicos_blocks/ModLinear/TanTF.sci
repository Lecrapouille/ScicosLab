...
case 'getinputs' then
  [x,y,typ]=TanTF_inputs(arg1)
case 'getoutputs' then
  [x,y,typ]=TanTF_outputs(arg1)
case 'getorigin' then
...
gr_i=["xpolys(orig(1)+[0.5,0.05;0.5,0.91]*sz(1),orig(2)+[0.89,0.5;0.05,0.5]*sz(2),[3,3])";
      ...
      "  xpolys(orig(1)+[0.1;0.108;0.116;0.128;0.144;0.1645;0.1965;0.2445;0.321;0.4779;0.667;0.747;0.7955;0.8275;0.852;0.868;0.88;0.888;0.9]*sz(1),"+...
        "orig(2)+[0.1;0.158;0.2015;0.25;0.2955;0.335;0.376;0.414;0.4501;0.49465;0.5456;0.581;0.616;0.653;0.6955;0.737;0.7805;0.819;0.9]*sz(2),5)";
      "  xset(''thickness'',2);";
      "  xset(''color'',[2,2]);";
      "  a=0.4;"
      ...
      "  xpolys(orig(1)+[0.9;0.892;0.884;0.872;0.856;0.8355;0.8035;0.7555;0.679;0.5221;0.333;0.253;0.2045;0.1725;0.148;0.132;0.12;0.112;0.1]*sz(1),"+...
        "orig(2)+[0.1;0.158;0.2015;0.25;0.2955;0.335;0.376;0.414;0.4501;0.49465;0.5456;0.581;0.616;0.653;0.6955;0.737;0.7805;0.819;0.9]*sz(2),5)";
      "  xset(''color'',12);";
      "  xset(''thickness'',2);";
      "  xset(''color'',[2,2]);";
...
//=========================
function [x,y,typ]=TanTF_inputs(o)
// Copyright INRIA
  xf=60
  yf=40
  [orig,sz,orient]=(o.graphics.orig,o.graphics.sz,o.graphics.flip)
...
//=========================
function [x,y,typ]=TanTF_outputs(o)
// Copyright INRIA
  xf=60
  yf=40
  [orig,sz,orient]=(o.graphics.orig,o.graphics.sz,o.graphics.flip)
