...
case 'getinputs' then
  [x,y,typ]=Gain_inputs(arg1)
case 'getoutputs' then
  [x,y,typ]=Gain_outputs(arg1)
case 'getorigin' then
...
exprs="1"
gr_i=["";"if orient then";"  xset(''color'',2)";"  xfpolys(orig(1)+[0;0;1;0]*sz(1),orig(2)+[0;1;0.5;0]*sz(2),8)";"  xstring(orig(1)+0.25*sz(1),orig(2)+0.5*sz(2),""k"")";"else";"  xset(''color'',2)";"  xfpolys(orig(1)+[1;1;0;1]*sz(1),orig(2)+[0;1;0.5;0]*sz(2),8)";"  xstring(orig(1)+sz(1)-(0.25*sz(1)),orig(2)+0.5*sz(2),""k"")";"end"]
model.blocktype='c'                              
model.dep_ut=[%f %t]                               
mo.model=ModelName                                 
model.equations=mo                                 
...
//=========================
function [x,y,typ]=Gain_inputs(o)
// Copyright INRIA
  xf=60
  yf=40
  [orig,sz,orient]=(o.graphics.orig,o.graphics.sz,o.graphics.flip)
...
//=========================
function [x,y,typ]=Gain_outputs(o)
// Copyright INRIA
  xf=60
  yf=40
  [orig,sz,orient]=(o.graphics.orig,o.graphics.sz,o.graphics.flip)
