...
//**        This function is called from "scilab/scilab.star" at Scilab's startup
  ...
  pal_names = ['Sources'    ;'Sinks'         ;'Events'        ;'Branching';
               ...
               'Iterators'  ;'Modelica'      ;'Lookup_Tables' ;'Threshold' ;
	       'Others'     ;'DemoBlocks'    ;'OldBlocks'];
 ...
 //**------------------------------
  ...
  modelica_libs='SCI/macros/scicos_blocks/'+['ModElectrical','ModHydraulics','ModLinear'];
  ...
  %scs_help_menu=scicos_help(%scs_help_menu,...
               ...
               [" Compiles the Modelica diagram (if necessary), and";
                "launches the Modelica initialization GUI"])
