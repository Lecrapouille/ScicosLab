...
// Start Scipad editor
    ...
    if with_tk() then
        ...
        if Scilab5 then
          ...
          TCL_eval_str = "source """+SCI+"/tcl/scipadsources/scipad.tcl"""; 
          TCL_eval_str1 = "scipad";
          if execstr('TCL_EvalStr(TCL_eval_str, TCL_eval_str1)','errcatch') <> 0 then 
            // printf("first start failed for scipad, restart again\n");
