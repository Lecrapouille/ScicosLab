...
//**
  ...
  elseif typeof(o)=='Link' then //** Link draw 
    ...
    gh_axes.font_style = options.ID(2)(1) ;
    gh_axes.font_size  = options.ID(2)(2) ;
    gh_axes.font_color = options.ID(2)(3) ; //@@
