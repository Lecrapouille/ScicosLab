...
[Setup]
AppName=ScicosLab svn
AppVerName=ScicosLab svn
AppVersion=svn
...
CreateAppDir=yes
DefaultDirName={sd}\Program Files\scicoslab-svn
DefaultGroupName=ScicosLab svn
...
Compression=bzip/9
OutputDir=..
OutputBaseFilename=scicoslabsvn-install
...
[Icons]
;;Name: {commonprograms}\ScicosLab svn; Filename: {app}\bin\wscilex.exe
Name: {commondesktop}\ScicosLab svn; Filename: {app}\bin\wscilex.exe
Name: {group}\ScicosLab svn; Filename: {app}\bin\wscilex.exe
Name: {group}\Uninstall ScicosLab svn; Filename: {uninstallexe}

[Tasks]
Name: fileassoc; Description: {cm:AssocFileExtension,ScicosLab svn,.sce}
Name: fileassoc; Description: {cm:AssocFileExtension,ScicosLab svn,.sci}
Name: fileassoc; Description: {cm:AssocFileExtension,ScicosLab svn,.cos}
Name: fileassoc; Description: {cm:AssocFileExtension,ScicosLab svn,.cosf}
