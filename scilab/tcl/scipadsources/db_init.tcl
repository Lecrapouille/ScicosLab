...
array unset varsforautowatch    ; # list of current variables for the auto watch feature input, output, nolocals and locals)
set watchgenexps {}
set callstackfuns ""
set callstacklines ""
...
# needed to reset initial state of the bptsgui as seen by proc showbptgui_bp
# when Scipad is closed and reopened
unset -nocomplain bptsgui

# the next two variables are intentionally not localized, see comments
# in proc updatebptspropscondtype and updatebptspropshitconds
set bptconditiontypes [list istrue haschanged]
set bpthitconditions  [list always equalto multipleof greaterthan lessthan]
...
set newsizex 32
set newsizey 32
image create photo butsetbptimage_o      -file [file join $dbgiconsdir setbp.gif]
image create photo buteditbptimage_o     -file [file join $dbgiconsdir editbp.gif]
image create photo butremoveallimage_o   -file [file join $dbgiconsdir removeallbp.gif]
image create photo butconfigureimage_o   -file [file join $dbgiconsdir arrowframe.gif]
image create photo butnextimage_o        -file [file join $dbgiconsdir arrowin.gif]
image create photo butstepimage_o        -file [file join $dbgiconsdir stepstep.gif]
image create photo butstepenterimage_o   -file [file join $dbgiconsdir arrowenter.gif]
image create photo butstepoverimage_o    -file [file join $dbgiconsdir arrowover.gif]
image create photo butstepexitimage_o    -file [file join $dbgiconsdir arrowexit.gif]
image create photo butruntoreturnimage_o -file [file join $dbgiconsdir arrowtoreturn.gif]
image create photo butruntocursorimage_o -file [file join $dbgiconsdir arrowcursor.gif]
image create photo butgoonignorimage_o   -file [file join $dbgiconsdir arrowignore.gif]
image create photo butwatchimage_o       -file [file join $dbgiconsdir arrowwatch.gif]
image create photo butbreakimage_o       -file [file join $dbgiconsdir arrowstop.gif]
image create photo butcancelimage_o      -file [file join $dbgiconsdir arrowend2.gif]
...
# Watch window LEDs
image create photo led_debugstate_NoDebug         -file [file join $dbgiconsdir dbs_NoDebug_48x24.gif]
image create photo led_debugstate_ReadyForDebug   -file [file join $dbgiconsdir dbs_ReadyForDebug_48x24.gif]
image create photo led_debugstate_DebugInProgress -file [file join $dbgiconsdir dbs_DebugInProgress_48x24.gif]
image create photo led_scilabbusy_busy  -file [file join $dbgiconsdir prompt_busy_48x24.gif]
image create photo led_scilabbusy_ready -file [file join $dbgiconsdir prompt_ready_48x24.gif]
