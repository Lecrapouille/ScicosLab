...
proc setdbmenuentriesstates_bp {} {
    ...
    if {[getdbstate] == "NoDebug"} {
        ...
        $pad.filemenu.scheme entryconfigure $MenuEntryId($pad.filemenu.scheme.[mcra "&Scilab"]) -state normal
        $pad.filemenu.scheme entryconfigure $MenuEntryId($pad.filemenu.scheme.[mcra "&Modelica"]) -state normal
        ...
        $pad.filemenu.scheme entryconfigure $MenuEntryId($pad.filemenu.scheme.[mcra "&Scilab"]) -state disabled
        $pad.filemenu.scheme entryconfigure $MenuEntryId($pad.filemenu.scheme.[mcra "&XML"]) -state disabled
        $pad.filemenu.scheme entryconfigure $MenuEntryId($pad.filemenu.scheme.[mcra "&Modelica"]) -state disabled
...
#          know what you're doing...!
    ...
    set removecomm [removeallbpt_scilab "no_output"]
    ...
    switch -- $stepmode {
        "nostep"   {
            ...
            set skipline "TCL_EvalStr(\\\"\"if {\\\[isnocodeorcondcontline \$curbptta \$curbptpos\\\] && \\\[isbreakhit_bp\\\]} {stepbystepover_bp 0 0 ; break_bp} else {getcallstackfromshell;updatewatchvars;unsetdebuggerbusycursor}\\\"\",\\\"\"scipad\\\"\");"
                   }
        "into"     {
            set skipline "TCL_EvalStr(\\\"\"if {\\\[isnocodeorcondcontline \$curbptta \$curbptpos\\\]} { stepbystepover_bp 0 0 ; if {\\\[isbreakhit_bp\\\]} {break_bp} } else {getcallstackfromshell;updatewatchvars;unsetdebuggerbusycursor}\\\"\",\\\"\"scipad\\\"\");"
                   }
        "over"     {
            ...
            set skipline "TCL_EvalStr(\\\"\"if {\\\[isnocodeorcondcontline \$curbptta \$curbptpos\\\]} { stepbystepover_bp 0 1 ; if {\\\[isbreakhit_bp\\\]} {break_bp} } else {getcallstackfromshell;updatewatchvars;unsetdebuggerbusycursor}\\\"\",\\\"\"scipad\\\"\");"
                   }
        "out"      {
            set skipline "TCL_EvalStr(\\\"\"if {\\\[isnocodeorcondcontline \$curbptta \$curbptpos\\\]} { stepbystepover_bp 0 0 ; if {\\\[isbreakhit_bp\\\]} {break_bp} } else {getcallstackfromshell;updatewatchvars;unsetdebuggerbusycursor}\\\"\",\\\"\"scipad\\\"\");"
                   }
        "runtocur" {
            ...
            set skipline2 "TCL_EvalStr(\\\"\"if {\\\[isnocodeorcondcontline \$curbptta \$curbptpos\\\]} { stepbystepover_bp 0 0 ; if {\\\[isbreakhit_bp\\\]} {break_bp} } else {getcallstackfromshell;updatewatchvars;unsetdebuggerbusycursor}\\\"\",\\\"\"scipad\\\"\");"
    ...
    set stoppedonarealbpt "TCL_EvalStr(\"lsearch -sorted -increasing -integer -exact \[getfunlinesfrombptsprops \" + db_m(3) + \"\] \[condphyslinetologline \" + db_m(3) + \" \" + msprintf(\"%d\",db_l(3)) + \"\] \" + \"\",\"scipad\") <> msprintf(\"%d\",-1)"
    ...
    switch -- $stepmode {
        "nostep"   {
                    ...
                    #set ID "\" + TCL_EvalStr(\"where2bptID \" + db_m(3) + \" \" + msprintf(\"%d\",db_l(3)) + \" true \" ,\"scipad\") + \""
                    ...
                    #   !<uppper levels> !
                    #   !execstr         !
                    set getbptIDcommand "db_BPTID=TCL_EvalStr(\"where2bptID \" + db_m(3) + \" \" + msprintf(\"%d\",db_l(3)) + \" true \" ,\"scipad\");"
                    ...
                    set isbpthit "(db_BPTID<>msprintf(\"%d\",-1)) & ($isbreakpointenabled & ( ($isconditiontypeistrue & db_condexprresult==FormatStringsForWatch(%t)) | \
    ...
    set comm8      "TCL_SetVar(\"prevdbpauselevel\",msprintf(\"%d\",$initprevdbpauselevel),\"scipad\");"
    set comm9  "else"
    ...
    set commdb            "TCL_SetVar(\"prevdbpauselevel\",msprintf(\"%d\",size(db_l,1)),\"scipad\");"
    set commdc         "end;"
    set commc2     "end;"
