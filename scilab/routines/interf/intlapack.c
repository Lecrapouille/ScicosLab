     ...
     
{
  ...
  int Cmplx; double *snd; double tol;
  ...
  if (Lhs==4) {   /* obsolete : [Q,R,rk,E]=qr(A) or = qr(A,tol)   */
    ...
    switch (Cmplx) {
    case REAL :
       C2F(doldqr)(&tol,"qr",2L);
       break;
    case COMPLEX :
      C2F(zoldqr)(&tol,"qr",2L); 
      break;
    default :
  ...
  case 1:   /*   qr(A)   */
    switch (Cmplx) {
    case REAL :
      C2F(intdgeqpf3)("qr",2L);
      break;
    case COMPLEX :
      C2F(intzgeqpf3)("qr",2L);
      break;
    default :
      Scierror(999,"%s: Invalid input! \r\n",fname);
      break;
  ...
  case 2 :   /*   qr(A, something)   */
    ...
    case STRING  :
      ...
      switch (Cmplx) {
      case REAL :
	 C2F(intdgeqpf4)("qr",2L);
	break;
      case COMPLEX :
	 C2F(intzgeqpf4)("qr",2L);  
	break;
      default :
	Scierror(999,"%s: Invalid input! \r\n",fname);
	break;
...
int C2F(intsvd)(char *fname,unsigned long fname_len)
{
  ...
  case 1:   /* s=svd(A)   or   [U,s,V]=svd(A)   */
    ...
    case 1: case 2: case 3:
      if (Cmplx==0) {
	 C2F(intdgesvd1)("svd",3L);
	return 0; }
      if (Cmplx==1) {
	 C2F(intzgesvd1)("svd",3L);
	return 0; } 
      break;
    case 4:
      if (Cmplx==0) {
	 C2F(intdoldsvd)((tol=0,&tol),"svd",3L);  
	return 0;}
      if (Cmplx==1) {
	 C2F(intzoldsvd)((tol=0,&tol),"svd",3L);  
	return 0;} 
      break;
    }
  case 2 :   /* svd(A, something)   */
	...
	if (Cmplx==0) {
	  tol = ((double *) header2)[2];
	   C2F(intdoldsvd)(&tol,"svd",3L);  
	  return 0;}
	if (Cmplx==1) {
	  tol = ((double *) header2)[2];
	   C2F(intzoldsvd)(&tol,"svd",3L);  
	  return 0;} 
      }
      else {
	/* old Economy size:  [U,S,V]=svd(A,0)  */
	if (Cmplx==0) {
	   C2F(intdgesvd2)("svd",3L);  
	  return 0;}
	if (Cmplx==1) {
	   C2F(intzgesvd2)("svd",3L);  
	  return 0;} 
      }
      break;
    case STRING  :
...
int C2F(intlsq)(char *fname,unsigned long fname_len)
{
  ...
  case REAL:   
    ...
    case REAL :
      /* A real, b real */
      C2F(intdgelsy)("lsq",3L);
      break;
    case COMPLEX :
      /* A real, b complex */
      C2F(complexify)((I2=1,&I2));
      C2F(intzgelsy)("lsq",3L);
      break;
    default:
      break;
    }
...
int C2F(inteig)(char *fname,unsigned long fname_len)
{
  ...
  case 1:   /* spec(A)   */
    ...
    case REAL:
      switch (Symmetric) {
      case NO :
	 C2F(intdgeev)("spec",4L);
	break;
      case YES :
	 C2F(intdsyev)("spec",4L);
	break;
      }
      break;
    case COMPLEX:
      switch (Symmetric) {
      case NO :
	 C2F(intzgeev)("spec",4L);
	break;
      case YES: 
	 C2F(intzheev)("spec",4L);
	break;
      }
      break;
    default:
...

{
  ...
  switch (CmplxA) {
  case REAL:   
     C2F(intdgetri)("inv",3L);
    return 0;
    break;
  case COMPLEX:
     C2F(intzgetri)("inv",3L);
    return 0;
    break;
  default:
    Scierror(999,"%s: Invalid input! \r\n",fname);
...
int C2F(intrcond)(char *fname,unsigned long fname_len)
{
  ...
  switch (CmplxA) {
  case REAL:   
     C2F(intdgecon)("rcond",5L);
    return 0;
    break;
  case COMPLEX:
     C2F(intzgecon)("rcond",5L);
    return 0;
    break;
  default:
    Scierror(999,"%s: Invalid input! \r\n",fname);
...

{
  ...
  switch (CmplxA) {
  case REAL:   
     C2F(intdpotrf)("chol",4L);
    return 0;
    break;
  case COMPLEX:
    C2F(intzpotrf)("chol",4L);
    return 0;
    break;
  default:
    Scierror(999,"%s: Invalid input! \r\n",fname);
...

{
  ...
  switch (CmplxA) {
  case REAL:   
     C2F(intdgehrd)("hess",4L);
    return 0;
    break;
  case COMPLEX:
     C2F(intzgehrd)("hess",4L);
    return 0;
    break;
  default:
    Scierror(999,"%s: Invalid input! \r\n",fname);
...
int C2F(intslash)(char *fname,unsigned long fname_len)
{
  ...
  case REAL:   
    ...
    case REAL :
      /* A real, Breal */
       C2F(intdgesv4)("slash",5L);
      break;
    case COMPLEX :
      /* A real, B complex : complexify A */
      C2F(complexify)((X=1,&X));
       C2F(intzgesv4)("slash",5L);
      break;
    default:
      Scierror(999,"%s: Invalid input! \r\n",fname);
      break;
...
int C2F(intbackslash)(char *fname,unsigned long fname_len)
{
  ...
  case REAL:   
    ...
    case REAL :
      /* A real, B real */
      C2F(intdgesv3)("lsq",3L);
      break;
    case COMPLEX :
      /* A real, B complex : complexify A */
      C2F(complexify)((X=1,&X));
      C2F(intzgesv3)("lsq",3L);
      break;
    default:
      Scierror(999,"%s: Invalid input! \r\n",fname);
      break;
...
int C2F(intschur)(char *fname,unsigned long fname_len)
{
  ...
  case 1:   /* schur(A)   */
    switch (CmplxA) {
    case REAL :
       C2F(intdgees0)("schur",5L);
      break;
    case COMPLEX :
      C2F(intzgees0)("schur",5L);
      break;
    default :
      Scierror(999,"%s: Invalid input! \r\n",fname);
      break;
  ...
  case 2 :   /* schur(A, something)   */
    ...
    case FUNCTION :
      switch (CmplxA) {
      case REAL :
	C2F(intoschur)("schur",5L);
	break;
      case COMPLEX :
	C2F(intzschur)("schur",5L);
	break;
      default :
	Scierror(999,"%s: Invalid input! \r\n",fname);
	break;
	...
	switch (CmplxA) {
	case REAL:
	  C2F(intfschur)("schur",5L);
	  break;
	case COMPLEX:
	  C2F(intzfschur)("schur",5L);
	  break;
	}
      }
      break;
	...
	Cmplx=1;}
      ...
      switch (Cmplx) {
      case REAL :
	C2F(intdgges)("schur",6L);
	break;
      case COMPLEX :
	C2F(intzgges)("schur",6L);
	break;
      default :
	Scierror(999,"%s: Invalid input! \r\n",fname);
	break;
  ...
  case 3: /* schur(A,B,something) */
    ...
    case FUNCTION :
      switch (Cmplx) {
      case REAL :
	C2F(intogschur)("schur",6L);
	break;
      case COMPLEX :
	C2F(intozgschur)("schur",6L);
	break;
      default :
	Scierror(999,"%s: Invalid input! \r\n",fname);
	break;
    ...
    case STRING  :
      switch (Cmplx) {
      case REAL:
	C2F(intgschur)("schur",6L);
	break;
      case COMPLEX:
	C2F(intzgschur)("schur",6L);
	break;
      default :
	Scierror(999,"%s: Invalid input! \r\n",fname);
	break;
...
int C2F(intbalanc)(char *fname,unsigned long fname_len)
{
  ...
  case 1:   /* balanc(A)   */
    ...
    switch (CmplxA) {
    case REAL:
      C2F(intdgebal)("balanc",6L);
      break;
    case COMPLEX:
      C2F(intzgebal)("balanc",6L);
      break;
    default:
      Scierror(999,"%s: Invalid input! \r\n",fname);
      break;
  ...
  case 2: /* balanc(A,B) */
    ...
    case REAL:   
      ...
      case REAL :
	/* A real, Breal */
	C2F(intdggbal)("balanc",6L);
	break;
      case COMPLEX :
	/* A real, B complex : complexify A */
	C2F(complexify)((X=1,&X));
	C2F(intzggbal)("balanc",6L);
	break;
      default:
	Scierror(999,"%s: Invalid input! \r\n",fname);
	break;
