/*
 * Graphic interface 
 * Copyright (C) 1998-2009 INRIA/Enpc 
...
extern int check_xy (char *fname, char dir, int mn, int xpos, int xm, int xn, long unsigned int xl, int ypos, int ym, int yn, long unsigned int yl, int *ntics);
extern void Objdrawaxis  (char dir,char tics,double *x,int *nx,double *y,int *ny,char **val,int subint,char *format,int font,int textcol,int ticscol,char flag,int seg,int nb_tics_labels);
extern void Xdrawaxis  (char dir,char tics,double *x,int *nx,double *y,int *ny,char **val,int sub_int,char *format,int fontsize,int textcolor,int ticscolor,char flag,int seg_flag);
extern void Objfec  (double *x,double *y,double *noeud,double *fun,integer *n,integer *m,char *strflag,char *legend,double *brect,integer *aaint,double *Zminmax,integer *Colminmax,integer *ExtremesCol, BOOL with_mesh, BOOL flagNax);
extern void Objnumb (char *fname,unsigned long fname_len,integer n,integer flag,double *x,double *y,double *angle,double *box);
extern void Xfec  (double *x,double *y,double *noeud,double *fun,integer *n,integer *m,char *strflag,char *legend,double *brect,integer *aaint,double *Zminmax,integer *Colminmax,integer *ColOut, BOOL with_mesh);
extern void Xfpoly  (integer rempl,integer closed,double *x,double *y);
extern void Xfpolys  (int *vect,integer val1,integer val2,integer n,integer m,double *x,double *y);
extern void Xnumb  (char *fname,unsigned long fname_len,integer flag,double *x,double *y,double *angle,double *box);
extern void Objfpoly  (double *x,double *y,integer rempl,integer *closed,long *hdl, int v1);
extern void seteventhandler(int *win_num,char *name,int *ierr);
extern void ShowScales(void);
extern void Xpolys  (integer *vect,integer n,integer m,double *x,double *y);
extern void Xrect  (char *fname,unsigned long fname_len,double *x,double *y,double *width,double *height);
extern void Objrect  (double *x,double *y,double *width,double *height,int *foreground,int *background,BOOL isfilled,BOOL isline,int n,long *hdl,BOOL flagxtring);
extern int zoom_box(double *bbox,int *x_pixel, int *y_pixel);
extern void unzoom_one_axes(sciPointObj *psousfen);
extern void Xrects  (char *fname,unsigned long fname_len,int *vect1,integer n,double *vect2);
extern void Xstring  (char *fname,unsigned long fname_len,integer str,double x,double y,double angle,double *box);
extern void Xtitle  (char *str,int n);
extern void Objstring (char *fname,unsigned long fname_len,integer str,double x,double y,
			       double *angle,double *box,double* wh, long *hdl, int fill,
			       int *foreground,int *background,BOOL isboxed,BOOL isline, BOOL isfilled);
extern void Xpoly  (char *fname,unsigned long fname_len,int n,int close,double *x,double *y);
extern void Objpoly  (double *x,double *y,integer n,integer closed,int mark,long *hdl);
extern void Xsegs  (integer *style,integer flag,integer n,double *x,double *y, double arsize);
extern void Objsegs  (integer *style,integer flag,integer n,double *x,double *y, double arsize);
extern void Xfarcs  (char *fname,unsigned long fname_len,int *vect1,int n,double *vect2);
extern void Xarc  (char *fname,unsigned long fname_len,int *a1,int *a2,double *x,double *y,double *width,double *height);
extern void Xarcs  (char *fname,unsigned long fname_len,int *vect1,integer n,double *vect2);
extern void Objmatplot1  (double *z,integer *n1,integer *n2,double *xrect);
extern void Xgrayplot  (double *x,double *y,double *z,integer *n1,integer *n2,char *strflag,double *brect,integer *aaint);
extern void Objarc  (int *angle1,int *angle2,double *x,double *y,double *width,double *height,int *foreground,int *background, BOOL isfilled, BOOL isline, long *hdl);
extern void Xmatplot1  (double *z,integer *n1,integer *n2,double *xrect);
extern void Xmatplot  (double *z,integer *n1,integer *n2,char *strflag,double *brect,integer *aaint);
extern void Objmatplot  (double *z,integer *n1,integer *n2,char *strflag,double *brect,integer *aaint, BOOL flagNax);
extern void Objgrayplot  (double *x,double *y,double *z,integer *n1,integer *n2,char *strflag,double *brect,integer *aaint, BOOL flagNax);
extern void Xplot3d  (char *fname,integer *isfac,integer *izcol,double *x,double *y,double *z,integer *zcol,integer *m,integer *n,double *theta,double *alpha,char *legend,integer *iflag,double *ebox);
extern void Objplot3d  (char *fname,integer *isfac,integer *izcol,double *x,double *y,double *z,double *zcol,integer *m,integer *n,double *theta,double *alpha,char *legend,integer *iflag,double *ebox, integer *m1, integer *n1, integer *m2, integer *n2, integer *m3, integer *n3,integer *m3n, integer *n3n);
extern void Xplot2d  (double *x,double *y,integer *n1,integer *n2,integer *style,char *strflag,char *legend,double *brect,integer *aaint);
extern void Objplot2d  (int ptype,char *logflags,double *x,double *y,integer *n1,integer *n2,integer *style,char *strflag,char *legend,double *brect,integer *aaint, BOOL flagNax);
...
{
  int verb=0,wid,cur,win,na, ix,m1,n1,l1 ;
  double dv;
  CheckRhs(0,2);
  CheckLhs(0,1);
  SciWin();
...
int scixclick(char *fname,unsigned long fname_len)
{
  ...
  switch (Lhs) {
  case 4 : 
    C2F(dr1)("xclickany",NULL,&ix,&iw,&iflag,&v,&v,&v,&x,&y,&dv,&dv,10L,3L);
    break;
  case 5 :
    istr = 1;
 ...
 OK:  
  ...
  if ( strcmp(cstk(l1),"fpf") == 0 || strcmp(cstk(l1),"auto clear") == 0) 
  ...
  else if ( strcmp(cstk(l1),"colormap") == 0) 
    {
      ...
      int m3,n3=3;
      /*      CheckColormap(&m3); */
      C2F(dr)("xget","cmap_size",&flagx,&m3,&x2,&v,&v,&v,&dv,&dv,&dv,&dv,5L,bsiz);
...
int scixinit(char *fname,unsigned long fname_len)
{
  ...
  if (Rhs <= 0 )
  ...
  else 
    {
      ...
      if(version_flag() == 0)
	{
	  /* we do not draw now into the file/memory 
...
extern int sci_exists_winid(int Num);
...
{ 
  ...
  if (Rhs >= 1) 
    ...
    {
      integer iflag=0,win_number;
      /* just get how many windows we have */
      C2F(getwins)(&win_number,NULL ,&iflag);
      if ( win_number > 0 ) 
	{
	  /* get the current window and delete it */
...
{
#ifdef WITH_GTK
  extern int Sci_Help(char *,char *,char *);
#endif
  int m1,n1,l1,m2,n2,l2,m3,n3,l3;
  CheckRhs(3,3);
  CheckLhs(0,1);
...
/* this function is used to be sure that a graphic window exists 
 */

int C2F(sciwin)(void)
{
  double dv;
  int win=0, max = GetWinsMaxId();
  /* if max != -1, then a graphic window is already active 
   * else we need to create one.
   */
  if ( max == -1 ) 
    {
      /* if no windows exists we create one */
      C2F(dr)("xset","window",&win,PI0,PI0,PI0,PI0,PI0,&dv,&dv,&dv,&dv,5L,7L);
      if (version_flag() == 0) 
	{ 
