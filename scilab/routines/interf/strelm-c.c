...
static int intgrep(char* fname,int len)
{
...
static int intascii(char* fname,int len) 
{ 
...
static int intstrcat(char* fname,int len) 
{ 
  char typ = '*';
  char **Str,**Str1;
  static char def_sep[] ="";
...
static int intstr2code(char* fname,int len) 
{ 
  static int un=1;
  int m1,n1,l1,mn,l2;
...
static int intcode2str(char* fname,int len) 
{ 
  static int un=1;
  int m1,n1,l1,mn,l2;
  CheckRhs(1,1);
...
static int intstrindex(char* fname,int len) 
{
...
static int intstrsubst(char* fname,int len) 
{
  char *needle,*replace ; 
  char **Str,**Str1;
...
static int intlength(char* fname,int len) 
{
  char **Str;
  static int un=1;
...
static int intconvstr(char* fname,int len) 
{
  char **Str;
  char flag = 'l'; 
...
static int intpart (char* fname,int len) 
{
  char **Str,**Str1;
  int m1,n1,m2,n2,l2;
...
static int intemptystr(char* fname,int len) 
{
  int *header;
  char **Str1;
...
static int intsort(char* fname,int len) 
{
  integer ix1;
  integer lind;
  integer tops, lszi;
  ...
  integer il, mn, ls, lw;
  integer id1, il1;
  integer idi, inc, sel, ilr, vol, lsz; 
...
static int intstring (char* fname,int len) 
{
...
static int intmacrostring(void)
{
  ...
  ++il;
  /*     first extract lout */
  C2F(listnames)(Top_stack + 1, &il);
  /*     first extract lin */
  C2F(listnames)(Top_stack + 2, &il);
...
typedef int (*des_interf) __PARAMS((char *fname, int len));
