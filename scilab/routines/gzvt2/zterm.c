 ...
 *  Adapted for scilab Jean-Philippe Chancelier 2003
 *
...
gint main (gint argc, gchar *argv[])
{
  ...
  */
  ...
  /*  zvt_term_new_with_size(80,24); seams to have no effect 
   *  the a set_usize is added (jpc May 2003)
   */
  ...
  /* zvt_term_set_size (ZVT_TERM (term), 800,240); */
