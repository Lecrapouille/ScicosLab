      subroutine mpwspis(ma,na,ar,ai,nela,inda,i,ni,j,nj,
c     Copyright INRIA
...
c     this line is not modified
               if(l.le.ma) then
                  ...
                  if(ita.ne.0) then
                     ...
                     call dset(indr(l),PCZERO,ri(jr),1)
                  endif
                  jr=jr+indr(l)
                  ja=ja+indr(l)
               else
...
c     indr(l)=nb  ????
 ...
 10                     continue
                        ...
                        do 11 k1=1,nb
                           if(abs(br(ii,k1))+abs(bi(ii,k1)).ne.PCZERO)
     $                          then
                              indr(mr+jr)=k1
                              rr(jr)=br(ii,k1)
                              ri(jr)=bi(ii,k1)
 ...
 12                        continue
                        ...
                        if(abs(br(1,1))+abs(bi(1,1)).ne.PCZERO) then
                           do 13 k1=1,na
                              indr(mr+jr)=k1
                              rr(jr)=br(1,1)
                              ri(jr)=bi(1,1)
                  ...
                  if(.not.bscal) then
                     if(nb.gt.0) then
                        if(itb.eq.0) then
                           ...
                           if(abs(br(l,jj))+abs(bi(l,jj)).ne.PCZERO
     $                          ) then
                              if(jr+1.gt.nelmx) then
                                 ierr=1
                                 return
                     ...
                     if(itb.eq.0) then
                        ...
                        if(abs(br(1,1))+abs(bi(1,1)).ne.PCZERO)
     $                       then
                           if(jr+1.gt.nelmx) then
                              ierr=1
                              return
