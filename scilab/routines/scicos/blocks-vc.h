...
extern void lookup_c __PARAMS((ARGS_scicos));
extern void tablex2d_c __PARAMS((ARGS_scicos));
extern void matbyscal __PARAMS((ARGS_scicos));
extern void matbyscal_s __PARAMS((ARGS_scicos));
extern void matbyscal_e __PARAMS((ARGS_scicos));
extern void matmul2_s __PARAMS((ARGS_scicos));
extern void matmul2_e __PARAMS((ARGS_scicos));
extern void constraint_c __PARAMS((ARGS_scicos));
extern void lookup2d __PARAMS((ARGS_scicos));
extern void diffblk_c __PARAMS((ARGS_scicos));
extern void andlog __PARAMS((ARGS_scicos));
extern void foriterator __PARAMS((ARGS_scicos));
extern void assignment __PARAMS((ARGS_scicos));
extern void whileiterator __PARAMS((ARGS_scicos));
extern void loopbreaker __PARAMS((ARGS_scicos));
extern void absolute_valuei_SCSREAL_COP __PARAMS((ARGS_scicos));
extern void absolute_valuei_SCSINT32_COP __PARAMS((ARGS_scicos));
extern void absolute_valuei_SCSINT16_COP __PARAMS((ARGS_scicos));
extern void absolute_valuei_SCSINT8_COP __PARAMS((ARGS_scicos));
extern void absolute_valuei_SCSUINT32_COP __PARAMS((ARGS_scicos));
extern void absolute_valuei_SCSUINT16_COP __PARAMS((ARGS_scicos));
extern void absolute_valuei_SCSUINT8_COP __PARAMS((ARGS_scicos));
extern void switch2_SCSREAL_COP __PARAMS((ARGS_scicos));
extern void switch2_SCSINT32_COP __PARAMS((ARGS_scicos));
extern void switch2_SCSINT16_COP __PARAMS((ARGS_scicos));
extern void switch2_SCSINT8_COP __PARAMS((ARGS_scicos));
extern void switch2_SCSUINT32_COP __PARAMS((ARGS_scicos));
extern void switch2_SCSUINT16_COP __PARAMS((ARGS_scicos));
extern void switch2_SCSUINT8_COP __PARAMS((ARGS_scicos));
 
OpTab tabsim[] ={
{"absblk",(ScicosF) F2C(absblk)},
{"absolute_valuei_SCSINT16_COP",(ScicosF) absolute_valuei_SCSINT16_COP},
{"absolute_valuei_SCSINT32_COP",(ScicosF) absolute_valuei_SCSINT32_COP},
{"absolute_valuei_SCSINT8_COP",(ScicosF) absolute_valuei_SCSINT8_COP},
{"absolute_valuei_SCSREAL_COP",(ScicosF) absolute_valuei_SCSREAL_COP},
{"absolute_valuei_SCSUINT16_COP",(ScicosF) absolute_valuei_SCSUINT16_COP},
{"absolute_valuei_SCSUINT32_COP",(ScicosF) absolute_valuei_SCSUINT32_COP},
{"absolute_valuei_SCSUINT8_COP",(ScicosF) absolute_valuei_SCSUINT8_COP},
...
{"switch2_SCSINT16_COP",(ScicosF) switch2_SCSINT16_COP},
{"switch2_SCSINT32_COP",(ScicosF) switch2_SCSINT32_COP},
{"switch2_SCSINT8_COP",(ScicosF) switch2_SCSINT8_COP},
{"switch2_SCSREAL_COP",(ScicosF) switch2_SCSREAL_COP},
{"switch2_SCSUINT16_COP",(ScicosF) switch2_SCSUINT16_COP},
{"switch2_SCSUINT32_COP",(ScicosF) switch2_SCSUINT32_COP},
{"switch2_SCSUINT8_COP",(ScicosF) switch2_SCSUINT8_COP},
