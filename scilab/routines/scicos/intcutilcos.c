...
extern int MlistGetFieldNumber __PARAMS((int *ptr, const char *string));
 ...
 *
 */
int intdata2sig(fname,fname_len)
     char *fname;
  ...
  switch(il1[0])
  {
   case 1 :
            ...
            *istk(il+3)    = it;
            if (it==0) {
              ...
              *Lstk(Top_stack+1) = l + n1*m1;
            }
            else if (it==1) {
              for(i=0;i<(2*m1*n1);i++) {
                stk(l)[i]  = *((double *)(&il1[4]) + i);
              }
              *Lstk(Top_stack+1) = l + 2*n1*m1;
            }
            break;
           }
   ...
   case 8 :
            ...
            *istk(il+3)    = it;
            if (it==4) {
              for(i=0;i<(m1*n1);i++) {
                *((SCSINT32_COP *)(istk(il+4)) + i)  = *((SCSINT32_COP *)(&il1[4]) + i);
              }
              *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1)/2)+1);
            }
            else if (it==2) {
              for(i=0;i<(m1*n1);i++) {
                *((SCSINT16_COP *)(istk(il+4)) + i)  = *((SCSINT16_COP *)(&il1[4]) + i);
              }
              *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1)/4)+1);
            }
            else if (it==1) {
              for(i=0;i<(m1*n1);i++) {
                *((char *)(istk(il+4)) + i)  = *((char *)(&il1[4]) + i);
              }
              *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1)/8)+1);
            }
            else if (it==14) {
              for(i=0;i<(m1*n1);i++) {
                *((SCSUINT32_COP *)(istk(il+4)) + i)  = *((SCSUINT32_COP *)(&il1[4]) + i);
              }
              *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1)/2)+1);
            }
            else if (it==12) {
              for(i=0;i<(m1*n1);i++) {
                *((SCSUINT16_COP *)(istk(il+4)) + i)  = *((SCSUINT16_COP *)(&il1[4]) + i);
              }
              *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1)/4)+1);
            }
            else if (it==11) {
              for(i=0;i<(m1*n1);i++) {
                *((SCSUINT8_COP *)(istk(il+4)) + i)  = *((SCSUINT8_COP *)(&il1[4]) + i);
              }
              *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1)/8)+1);
            }
            break;
   ...
   case 17 :
            ...
            *istk(il+3)   = 4;
            for(i=0;i<(n2h);i++) {
              *((SCSINT32_COP *)(istk(il+4)) + i)  = *((SCSINT32_COP *)(&ilh2[4]) + i);
            }
            *Lstk(Top_stack+1) = l + (int)(ceil((n2h)/2)+1);
             ...
             case 1 :
                      ...
                      *istk(il+3)    = it;
                      if (it==0) {
                        ...
                        *Lstk(Top_stack+1) = l + n1*m1*p1;
                      }
                      else if (it==1) {
                        for(i=0;i<(2*m1*n1*p1);i++) {
                           stk(l)[i] = *((double *)(&ilh3[4]) + i);
                        }
                        *Lstk(Top_stack+1) = l + 2*n1*m1*p1;
                      }
                      break;
                     }
             case 8 :
                      ...
                      *istk(il+3)    = it;
                      if (it==4) {
                        for(i=0;i<(m1*n1*p1);i++) {
                          *((SCSINT32_COP *)(istk(il+4)) + i)  = *((SCSINT32_COP *)(&ilh3[4]) + i);
                        }
                        *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1*p1)/2)+1);
                      }
                      else if (it==2) {
                        for(i=0;i<(m1*n1*p1);i++) {
                          *((SCSINT16_COP *)(istk(il+4)) + i)  = *((SCSINT16_COP *)(&ilh3[4]) + i);
                        }
                        *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1*p1)/4)+1);
                      }
                      else if (it==1) {
                        for(i=0;i<(m1*n1*p1);i++) {
                          *((char *)(istk(il+4)) + i)  = *((char *)(&ilh3[4]) + i);
                        }
                        *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1*p1)/8)+1);
                      }
                      else if (it==14) {
                        for(i=0;i<(m1*n1*p1);i++) {
                          *((SCSUINT32_COP *)(istk(il+4)) + i)  = *((SCSUINT32_COP *)(&ilh3[4]) + i);
                        }
                        *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1*p1)/2)+1);
                      }
                      else if (it==12) {
                        for(i=0;i<(m1*n1*p1);i++) {
                          *((SCSUINT16_COP *)(istk(il+4)) + i)  = *((SCSUINT16_COP *)(&ilh3[4]) + i);
                        }
                        *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1*p1)/4)+1);
                      }
                      else if (it==11) {
                        for(i=0;i<(m1*n1*p1);i++) {
                          *((SCSUINT8_COP *)(istk(il+4)) + i)  = *((SCSUINT8_COP *)(&ilh3[4]) + i);
                        }
                        *Lstk(Top_stack+1) = l + (int)(ceil((n1*m1*p1)/8)+1);
                      }
                      break;
 ...
 *
 */
int intsig2data(fname,fname_len)
     char *fname;
     unsigned long fname_len;
{
  int m1,n1;
  ...
  ierr=CopyVarFromlistentry(Top_stack-Rhs+2,il1,3);
  LhsVar(1)=2;
  if (Lhs==2) {
    ierr=CopyVarFromlistentry(Top_stack-Rhs+3,il1,4);
    LhsVar(2)=3;
  }
     ...
     unsigned long fname_len;
{
  ...
  SCSUINT8_COP *ptr_uc;
  SCSINT16_COP *ptr_s;
  SCSUINT16_COP *ptr_us;
  SCSINT32_COP *ptr_l;
  SCSUINT32_COP *ptr_ul;
    ...
    for(i=0;i<Block.nin;i++) {
      switch(Block.insz[2*Block.nin+i])
      {
       ...
       case 11  : if ((Block.inptr[i]=(double *) \
                  ...
                  break;
       case 84  : if ((Block.inptr[i]=(SCSINT32_COP *) \
                  ...
                  break;
       case 82  : if ((Block.inptr[i]=(SCSINT16_COP *) \
                        MALLOC(Block.insz[i]*Block.insz[Block.nin+i]*sizeof(SCSINT16_COP)))==NULL) {
                    for(j=0;j<i;j++) FREE(Block.inptr[j]);
                    FREE(Block.inptr);
                    FREE(Block.insz);
                    Scierror(888,"%s : Allocation error.\n",fname);
                  ...
                  ptr_s = (SCSINT16_COP *) Block.inptr[i];
                  for(j=0;j<Block.insz[i]*Block.insz[Block.nin+i];j++) {
                    ptr_s[j]=0;
                  }
                  break;
       case 81  : if ((Block.inptr[i]=(SCSINT8_COP *) \
                        MALLOC(Block.insz[i]*Block.insz[Block.nin+i]*sizeof(SCSINT8_COP)))==NULL) {
                    for(j=0;j<i;j++) FREE(Block.inptr[j]);
                    FREE(Block.inptr);
                    FREE(Block.insz);
                    Scierror(888,"%s : Allocation error.\n",fname);
                  ...
                  ptr_c = (SCSINT8_COP *) Block.inptr[i];
                  for(j=0;j<Block.insz[i]*Block.insz[Block.nin+i];j++) {
                    ptr_c[j]=0;
                  }
                  break;
       case 814 : if ((Block.inptr[i]=(SCSUINT32_COP *) \
                  ...
                  break;
       case 812 : if ((Block.inptr[i]=(SCSUINT16_COP *) \
                        MALLOC(Block.insz[i]*Block.insz[Block.nin+i]*sizeof(SCSUINT16_COP)))==NULL) {
                    for(j=0;j<i;j++) FREE(Block.inptr[j]);
                    FREE(Block.inptr);
                    FREE(Block.insz);
                    Scierror(888,"%s : Allocation error.\n",fname);
                  ...
                  ptr_us = (SCSUINT16_COP *) Block.inptr[i];
                  for(j=0;j<Block.insz[i]*Block.insz[Block.nin+i];j++) {
                    ptr_us[j]=0;
                  }
                  break;
       case 811 : if ((Block.inptr[i]=(SCSUINT8_COP *) \
                        MALLOC(Block.insz[i]*Block.insz[Block.nin+i]*sizeof(SCSUINT8_COP)))==NULL) {
                    for(j=0;j<i;j++) FREE(Block.inptr[j]);
                    FREE(Block.inptr);
                    FREE(Block.insz);
                    Scierror(888,"%s : Allocation error.\n",fname);
                  ...
                  ptr_uc = (SCSUINT8_COP *) Block.inptr[i];
                  for(j=0;j<Block.insz[i]*Block.insz[Block.nin+i];j++) {
                    ptr_uc[j]=0;
                  }
                  break;
    ...
    for(i=0;i<Block.nout;i++) {
      switch(Block.outsz[2*Block.nout+i])
      {
       ...
       case 11  : if ((Block.outptr[i]=(double *) \
                  ...
                  break;
       case 84  : if ((Block.outptr[i]=(SCSINT32_COP *) \
                  ...
                  break;
       case 82  : if ((Block.outptr[i]=(SCSINT16_COP *) \
                        MALLOC(Block.outsz[i]*Block.outsz[Block.nout+i]*sizeof(SCSINT16_COP)))==NULL) {
                    for(j=0;j<Block.nin;j++) FREE(Block.inptr[j]);
                    FREE(Block.inptr);
                    FREE(Block.insz);
                    for(j=0;j<i;j++) FREE(Block.outptr[j]);
                  ...
                  ptr_s = (SCSINT16_COP *) Block.outptr[i];
                  for(j=0;j<Block.outsz[i]*Block.outsz[Block.nout+i];j++) {
                    ptr_s[j]=0;
                  }
                  break;
       case 81  : if ((Block.outptr[i]=(char *) \
                  ...
                  break;
       case 814 : if ((Block.outptr[i]=(SCSUINT32_COP *) \
                  ...
                  break;
       case 812 : if ((Block.outptr[i]=(SCSUINT16_COP *) \
                        MALLOC(Block.outsz[i]*Block.outsz[Block.nout+i]*sizeof(SCSUINT16_COP)))==NULL) {
                    for(j=0;j<Block.nin;j++) FREE(Block.inptr[j]);
                    FREE(Block.inptr);
                    FREE(Block.insz);
                    for(j=0;j<i;j++) FREE(Block.outptr[j]);
                  ...
                  ptr_us = (SCSUINT16_COP *) Block.outptr[i];
                  for(j=0;j<Block.outsz[i]*Block.outsz[Block.nout+i];j++) {
                    ptr_us[j]=0;
                  }
                  break;
       case 811 : if ((Block.outptr[i]=(SCSUINT8_COP *) \
                        MALLOC(Block.outsz[i]*Block.outsz[Block.nout+i]*sizeof(SCSUINT8_COP)))==NULL) {
                    for(j=0;j<Block.nin;j++) FREE(Block.inptr[j]);
                    FREE(Block.inptr);
                    FREE(Block.insz);
                    for(j=0;j<i;j++) FREE(Block.outptr[j]);
                  ...
                  ptr_uc = (SCSUINT8_COP *) Block.outptr[i];
                  for(j=0;j<Block.outsz[i]*Block.outsz[Block.nout+i];j++) {
                    ptr_uc[j]=0;
                  }
                  break;
    ...
    for (i=0;i<mh*nh;i++) {
      ...
      if (ilh2[0]==1) {
        ...
        if (ilh2[3]==4) {
          ...
          Block.oztyp[i] = 82;
          if ((Block.ozptr[i]=(SCSINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSINT16_COP)))==NULL) {
            for(j=0;j<Block.nin;j++) FREE(Block.inptr[j]);
            FREE(Block.inptr);
            FREE(Block.insz);
            for(j=0;j<Block.nout;j++) FREE(Block.outptr[j]);
          ...
          ptr_s = (SCSINT16_COP *) Block.ozptr[i];
          for(j=0;j<mh2*nh2;j++) {
            ptr_s[j]=*((SCSINT16_COP *)(&ilh2[4]) + j);
          }
        }
        else if (ilh2[3]==1) {
          Block.oztyp[i] = 81;
          if ((Block.ozptr[i]=(SCSINT8_COP *) MALLOC(mh2*nh2*sizeof(SCSINT8_COP)))==NULL) {
            for(j=0;j<Block.nin;j++) FREE(Block.inptr[j]);
            FREE(Block.inptr);
            FREE(Block.insz);
            for(j=0;j<Block.nout;j++) FREE(Block.outptr[j]);
          ...
          ptr_c = (SCSINT8_COP *) Block.ozptr[i];
          for(j=0;j<mh2*nh2;j++) {
            ptr_c[j]=*((SCSINT8_COP *)(&ilh2[4]) + j);
          }
        }
        else if (ilh2[3]==14) {
          Block.oztyp[i] = 814;
          ...
          Block.oztyp[i] = 812;
          if ((Block.ozptr[i]=(SCSUINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT16_COP)))==NULL) {
            for(j=0;j<Block.nin;j++) FREE(Block.inptr[j]);
            FREE(Block.inptr);
            FREE(Block.insz);
            for(j=0;j<Block.nout;j++) FREE(Block.outptr[j]);
          ...
          ptr_us = (SCSUINT16_COP *) Block.ozptr[i];
          for(j=0;j<mh2*nh2;j++) {
            ptr_us[j]=*((SCSUINT16_COP *)(&ilh2[4]) + j);
          }
        }
        else if (ilh2[3]==11) {
          Block.oztyp[i] = 811;
          if ((Block.ozptr[i]=(SCSUINT8_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT8_COP)))==NULL) {
            for(j=0;j<Block.nin;j++) FREE(Block.inptr[j]);
            FREE(Block.inptr);
            FREE(Block.insz);
            for(j=0;j<Block.nout;j++) FREE(Block.outptr[j]);
          ...
          ptr_uc = (SCSUINT8_COP *) Block.ozptr[i];
          for(j=0;j<mh2*nh2;j++) {
            ptr_uc[j]=*((SCSUINT8_COP *)(&ilh2[4]) + j);
          }
        }
      }
      /* TODO : UNKNOWN type */
    ...
    for (i=0;i<mh*nh;i++) {
      ...
      if (ilh2[0]==1) {
        ...
        if (ilh2[3]==4) {
          ...
          Block.opartyp[i] = 82;
          if ((Block.oparptr[i]=(SCSINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSINT16_COP)))==NULL) {
            for(j=0;j<Block.nin;j++) FREE(Block.inptr[j]);
            FREE(Block.inptr);
            FREE(Block.insz);
            for(j=0;j<Block.nout;j++) FREE(Block.outptr[j]);
          ...
          ptr_s = (SCSINT16_COP *) Block.oparptr[i];
          for(j=0;j<mh2*nh2;j++) {
            ptr_s[j]=*((SCSINT16_COP *)(&ilh2[4]) + j);
          }
        }
          ...
          Block.opartyp[i] = 812;
          if ((Block.oparptr[i]=(SCSUINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT16_COP)))==NULL) {
            for(j=0;j<Block.nin;j++) FREE(Block.inptr[j]);
            FREE(Block.inptr);
            FREE(Block.insz);
            for(j=0;j<Block.nout;j++) FREE(Block.outptr[j]);
          ...
          ptr_us = (SCSUINT16_COP *) Block.oparptr[i];
          for(j=0;j<mh2*nh2;j++) {
            ptr_us[j]=*((SCSUINT16_COP *)(&ilh2[4]) + j);
          }
        }
          ...
          Block.opartyp[i] = 811;
          if ((Block.oparptr[i]=(SCSUINT8_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT8_COP)))==NULL) {
            for(j=0;j<Block.nin;j++) FREE(Block.inptr[j]);
            FREE(Block.inptr);
            FREE(Block.insz);
            for(j=0;j<Block.nout;j++) FREE(Block.outptr[j]);
          ...
          ptr_uc = (SCSUINT8_COP *) Block.oparptr[i];
          for(j=0;j<mh2*nh2;j++) {
            ptr_uc[j]=*((SCSUINT8_COP *)(&ilh2[4]) + j);
          }
        }
  ...
  if (Block->noz!=0) {
    ...
    for(i=0;i<Block->noz;i++) {
      ...
      switch(Block->oztyp[i])
      {
       ...
       case 84  : if ((Block->ozptr[i]=(SCSINT32_COP *) MALLOC(mh2*nh2*sizeof(SCSINT32_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<i;j++) FREE(Block->ozptr[j]);
       ...
       case 82  : if ((Block->ozptr[i]=(SCSINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSINT16_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<i;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSINT16_COP *)Block->ozptr[i], \
                         (SCSINT16_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSINT16_COP));
                  break;
       ...
       case 814 : if ((Block->ozptr[i]=(SCSUINT32_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT32_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<i;j++) FREE(Block->ozptr[j]);
       ...
       case 812 : if ((Block->ozptr[i]=(SCSUINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT16_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<i;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSUINT16_COP *)Block->ozptr[i], \
                         (SCSUINT16_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSUINT16_COP));
                  break;

       case 811 : if ((Block->ozptr[i]=(SCSUINT8_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT8_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<i;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSUINT8_COP *)Block->ozptr[i], \
                         (SCSUINT8_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSUINT8_COP));
                  break;
      }
    }
  }
  ...
  if (Block->nin!=0) {
    ...
    for(i=0;i<Block->nin;i++) {
      ...
      switch(Block->insz[2*Block->nin+i])
      {
       ...
       case 84  : if ((Block->inptr[i]=(SCSINT32_COP *) MALLOC(mh2*nh2*sizeof(SCSINT32_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
       ...
       case 82  : if ((Block->inptr[i]=(SCSINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSINT16_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSINT16_COP *)Block->inptr[i], \
                         (SCSINT16_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSINT16_COP));
                  break;
       ...
       case 814 : if ((Block->inptr[i]=(SCSUINT32_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT32_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
       ...
       case 812 : if ((Block->inptr[i]=(SCSUINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT16_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSUINT16_COP *)Block->inptr[i], \
                         (SCSUINT16_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSUINT16_COP));
                  break;

       case 811 : if ((Block->inptr[i]=(SCSUINT8_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT8_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSUINT8_COP *)Block->inptr[i], \
                         (SCSUINT8_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSUINT8_COP));
                  break;
      }
  ...
  if (Block->nout!=0) {
    ...
    for(i=0;i<Block->nout;i++) {
      ...
      switch(Block->outsz[2*Block->nout+i])
      {
       ...
       case 84  : if ((Block->outptr[i]=(SCSINT32_COP *) MALLOC(mh2*nh2*sizeof(SCSINT32_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
       ...
       case 82  : if ((Block->outptr[i]=(SCSINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSINT16_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSINT16_COP *)Block->outptr[i], \
                         (SCSINT16_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSINT16_COP));
                  break;
       ...
       case 814 : if ((Block->outptr[i]=(SCSUINT32_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT32_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
       ...
       case 812 : if ((Block->outptr[i]=(SCSUINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT16_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSUINT16_COP *)Block->outptr[i], \
                         (SCSUINT16_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSUINT16_COP));
                  break;

       case 811 : if ((Block->outptr[i]=(SCSUINT8_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT8_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSUINT8_COP *)Block->outptr[i], \
                         (SCSUINT8_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSUINT8_COP));
                  break;
      }
  ...
  if (Block->nopar!=0) {
    ...
    for(i=0;i<Block->nopar;i++) {
      ...
      switch(Block->opartyp[i])
      {
       ...
       case 84  : if ((Block->oparptr[i]=(SCSINT32_COP *) MALLOC(mh2*nh2*sizeof(SCSINT32_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
       ...
       case 82  : if ((Block->oparptr[i]=(SCSINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSINT16_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSINT16_COP *)Block->oparptr[i], \
                         (SCSINT16_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSINT16_COP));
                  break;
       ...
       case 814 : if ((Block->oparptr[i]=(SCSUINT32_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT32_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
       ...
       case 812 : if ((Block->oparptr[i]=(SCSUINT16_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT16_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSUINT16_COP *)Block->oparptr[i], \
                         (SCSUINT16_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSUINT16_COP));
                  break;

       case 811 : if ((Block->oparptr[i]=(SCSUINT8_COP *) MALLOC(mh2*nh2*sizeof(SCSUINT8_COP)))==NULL) {
                    FREE(Block->z);
                    FREE(Block->ozsz);
                    FREE(Block->oztyp);
                    for(j=0;j<Block->noz;j++) FREE(Block->ozptr[j]);
                  ...
                  memcpy((SCSUINT8_COP *)Block->oparptr[i], \
                         (SCSUINT8_COP *)(&ilh2[4]), \
                         mh2*nh2*sizeof(SCSUINT8_COP));
                  break;
      }
