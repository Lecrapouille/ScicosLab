...
(integer *) NULL,      /* 55 - nordclk ** */
(integer *) NULL,      /* 56 - clkptr **  */
(integer *) NULL,      /* 57 - ordptr **  */
(integer *) NULL,      /* 58 - nordptr    */
(integer *) NULL,      /* 59 - critev **  */
(integer *) NULL,      /* 60 - iwa        */
(integer *) NULL,      /* 61 - mask       */
...
(integer *) NULL,      /* 71 - nelem      */
(integer *) NULL,      /* 72 - xprop      */
(double *)  NULL,      /* 73 - xd         */
};
...
C2F(clearscicosimport)()
{
    ...
    scicos_imp.nordclk=(integer *) NULL;
