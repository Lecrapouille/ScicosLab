...
C    *S1,S2,Y,Z,ZB,ZETA1,ZETA1D,ZETA2,ZETA2D,ZN,ZR
     ...
     * ZET2DR, ZI, ZNI, ZNR, ZR, ZRI, ZRR, D1MACH, ZABSSCI
...
C-----------------------------------------------------------------------
        APHI = ZABSSCI(PHIR(J),PHII(J))
        AARG = ZABSSCI(ARGR(J),ARGI(J))
