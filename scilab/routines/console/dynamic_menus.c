...
#include "../wsci/GetOS.h"
  ...
  switch (GetOSVersion())
    ...
    case OS_WIN32_WINDOWS_SERVER_2008 :
      sprintf(Release,"%s","Server 2008");
      break;
    case OS_WIN32_WINDOWS_SERVER_2008_64 :
      sprintf(Release,"%s","Server 2008 x64");
      break;
    case OS_WIN32_WINDOWS_SEVEN :
      sprintf(Release,"%s","Seven");
      break;
    case OS_WIN32_WINDOWS_SEVEN_64 :
      sprintf(Release,"%s","Seven x64");
      break;
    case OS_WIN32_WINDOWS_SEVEN_SERVER :
      sprintf(Release,"%s","Seven Server");
      break;
    case OS_WIN32_WINDOWS_SEVEN_SERVER_64 :
      sprintf(Release,"%s","Seven Server x64");
      break;
    }
#else
  uname(&uname_pointer);
