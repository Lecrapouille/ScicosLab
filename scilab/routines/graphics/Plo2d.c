  ...
  if ( strflag[1] == '3' || strflag[1] == '4')
    {
      ...
      wdim[0]=linint((double)wdim[0] * (WRect[2]*(1.0 - ARect[0] - ARect[1]))); /* modif bruno pour marges */
      wdim[1]=linint((double)wdim[1] * (WRect[3]*(1.0 - ARect[2] - ARect[3]))); /* modif bruno pour marges */
      /* end of added code by S. Mottelet 11/7/2000 */
