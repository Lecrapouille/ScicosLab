...
void C2F(Write2VectXfig)(int *vx, int *vy, int n, int flag); 
void C2F(WriteGenericXfig)(char *string, int nobj, int sizeobj, int *vx, int *vy, int sizev, int flag, int *fvect);
void C2F(InitScilabGCXfig)(int *v1, int *v2, int *v3, int *v4);
static void SetGraphicsVersion();
void C2F(setforegroundXfig)(int *num, int *v2, int *v3, int *v4);
void C2F(ScilabGCGetorSetXfig)(char *str, int flag, int *verbose, int *x1, int *x2, int *x3, int *x4, int *x5, int *x6, double *dx1);
void C2F(setbackgroundXfig)(int *num, int *v2, int *v3, int *v4);
void C2F(set_cXfig)(int i);
void C2F(idfromnameXfig) (char *name1, int *num);
void C2F(getdashXfig)(int *verbose, int *value, int *narg, double *dummy);

/* NG beg */
void C2F(setscilabFigureXfig)(int *v1,int *v2,int *v3,int *v4,int *v5,int *v6,double *figure);
void C2F(getscilabFigureXfig)(int *verbose, int *x,int *narg, double *figure);
void C2F(setscilabVersionXfig)(int *vers, int *v2, int *v3, int *v4);
void C2F(getscilabVersionXfig)(int *verbose, int *vers, int *narg, double *dummy);
void C2F(setscilabxgcXfig)(int *v1, int *v2, int *v3, int *v4); 
void C2F(getscilabxgcXfig)(int *verbose, int *x,int *narg, double *dummy);
/* NG end */

static void 
C2F(analyze_pointsXfig) (int n, int *vx, int *vy,
			 int onemore);
/* static void  */
/* C2F(analyze_pointsXfigForFilling)(int n, int *vx, int *vy, */
/* 				  int onemore, int cpat); */
/* static void MyDrawForFilling(int iib, int iif, int *vx, int *vy, int fvect); */
/* static void My2drawForFilling(int j, int *vx, int *vy, int fvect); */

static void C2F(displaysymbolsXfig) (char *str, int *n, int *vx, int *vy);
static int C2F(FigQueryFont)(const char *name);
...
static int FontsListXfig_[FONTNUMBER][FONTMAXSIZE];
struct SciFontInfo {
  int ok;
  char fname[128];
} 
  FontInfoTabXfig_[FONTNUMBER];
/** xfig code for our fonts **/
static int  xfig_font[]= { 12,32,0,1,2,3,16,17,18,19,0};
...
void C2F(xselgraphicXfig)(char *v1, int *v2, int *v3, int *v4, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{}
...
void C2F(xendXfig)(char *v1, int *v2, int *v3, int *v4, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{
  C2F(xendgraphicXfig)();
}
...
void C2F(clearwindowXfig)(char *v1, int *v2, int *v3, int *v4, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{
...
void C2F(getwindowdimXfig)(int *verbose, int *x, int *narg, double *dummy)
{     
  *narg = 2;
  x[0]= 600*prec_fact;
  x[1]= 424*prec_fact;
...
void C2F(setwindowdimXfig)(int *x, int *y, int *v3, int *v4)
{
}

/** to get the window upper-left point coordinates return 0,0 **/

void C2F(getwindowposXfig)(int *verbose, int *x, int *narg, double *dummy)
{
  *narg = 2;
  x[0]= x[1]=0;
  if (*verbose == 1) 
...
void C2F(setwindowposXfig)(int *x, int *y, int *v3, int *v4)
{
}
...
void C2F(xpauseXfig)(char *str, int *sec_time, int *v3, int *v4, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{}

/** Wait for mouse click in graphic window : Empty here **/

void C2F(xclickXfig)(char *str, int *ibutton, int *xx1, int *yy1, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{ }

/** Wait for mouse click in any graphic window : Empty here **/

void C2F(xclick_anyXfig)(char *str, int *ibutton, int *xx1, int *yy1, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{ }

void C2F(xgetmouseXfig)(char *str, int *ibutton, int *xx1, int *yy1, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{ }

/** Clear a rectangle **/

void C2F(clearareaXfig)(char *str, int *x, int *y, int *w, int *h, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{
...
void C2F(setcurwinXfig)(int *intnum, int *v2, int *v3, int *v4)
{
...
void C2F(getcurwinXfig)(int *verbose, int *intnum, int *narg, double *dummy)
{
  *narg =1 ;
...
void C2F(setclipXfig)(int *x, int *y, int *w, int *h)
{
  if ( ScilabGCXfig_is_initialized == FALSE ) {
    sciprint("xinit must be called before any action \r\n");
    return;
...
void C2F(unsetclipXfig)(int *v1, int *v2, int *v3, int *v4)
{
...
void C2F(getclipXfig)(int *verbose, int *x, int *narg, double *dummy)
{
...
void C2F(absourelXfig)(int *num, int *v2, int *v3, int *v4)
{
  if (*num == 0 )
...
void C2F(getabsourelXfig)(int *verbose, int *num, int *narg, double *dummy)
{
  *narg = 1;
...
void C2F(setalufunction1Xfig)(int *num, int *v2, int *v3, int *v4)
{     
  int value;
...
void C2F(getalufunctionXfig)(int *verbose, int *value, int *narg, double *dummy)
{ 
  *narg =1 ;
...
void C2F(setthicknessXfig)(int *value, int *v2, int *v3, int *v4)
{ 
...
void C2F(getthicknessXfig)(int *verbose, int *value, int *narg, double *dummy)
{
  *narg =1 ;
...
void C2F(setpatternXfig)(int *num, int *v2, int *v3, int *v4)
{ int i ; 
...
void C2F(getpatternXfig)(int *verbose, int *num, int *narg, double *dummy)
{ 
  *narg=1;
  if ( ScilabGCXfig.CurColorStatus ==1) 
    {
...
void C2F(getlastXfig)(int *verbose, int *num, int *narg, double *dummy)
{
...
void C2F(set_dash_or_color_Xfig)(int *value, int *v2, int *v3, int *v4)
{
  int maxdash = MAXDASH ;
  int l3 ;
...
void C2F(setdashXfig)(int *value, int *v2, int *v3, int *v4)
{
  int maxdash = MAXDASH ;
  int l3 ;
...
void C2F(set_dash_and_color_Xfig)(int *value, int *v2, int *v3, int *v4)
{
  if ( ScilabGCXfig_is_initialized == FALSE ) {
    sciprint("xinit must be called before any action \r\n");
    return;
...
void C2F(set_line_style_Xfig)(int *value, int *v2, int *v3, int *v4)
{
  int j; 
...
void C2F(get_dash_or_color_Xfig)(int *verbose, int *value, int *narg, double *dummy)
{
  *narg =1 ;
...
void C2F(get_dash_and_color_Xfig)(int *verbose, int *value, int *narg, double *dummy)
{
...
void C2F(usecolorXfig)(int *num, int *v2, int *v3, int *v4)
{
  int i;
...
void C2F(getusecolorXfig)(int *verbose, int *num, int *narg, double *dummy)
{
 ...
 ******************************************************/
void setcolormapgXfig(struct  BCG *Xgc,int *v1,int *v2, double *a, int *v3);/* NG */

void C2F(setgccolormapXfig)(struct BCG *Xgc,int m, double *a, int *v3)
{
  int i,mm;
...
void C2F(getcolormapsizeXfig)(int *v1, int *v2, int *v3, double *val)
{
  if ( ScilabGCXfig_is_initialized == FALSE ) {
    sciprint("xinit must be called before any action \r\n");
    *v3 = 1;
...
void C2F(getcolormapXfig)(int *v1, int *v2, int *v3, double *val)
{
  int m;
  int i;
  *v3 = 0;
...
void C2F(setcolormapXfig)(int *v1, int *v2, int *v3, int *v4, int *v5, int *v6, double *a)
{
...
/* 1: failed */
/* NG beg*/
void setcolormapgXfig(struct  BCG *Xgc,int *m,int *v2, double *a, int *v3) /* NG */
{
...
void C2F(getbackgroundXfig)(int *verbose, int *num, int *narg, double *dummy)
{ 
  *narg=1;
...
void C2F(getforegroundXfig)(int *verbose, int *num, int *narg, double *dummy)
{ 
  *narg=1;
...
void C2F(sethidden3dXfig)(int *num, int *v2, int *v3, int *v4)
{ 
  if ( ScilabGCXfig_is_initialized == FALSE ) {
    sciprint("xinit must be called before any action \r\n");
    return;
...
void C2F(gethidden3dXfig)(int *verbose, int *num, int *narg, double *dummy)
{ 
  *narg=1;
...
/* void C2F(xsetfontXfig)(int *fontid, int *fontsize, int *v3, int *v4) */
/* { int i,fsiz; */
...
void C2F(xgetfontXfig)(int *verbose, int *font, int *nargs, double *dummy)
{
  *nargs=2;
...
void C2F(setcursymbolXfig)(int *number, int *size, int *v3, int *v4)
{ 
  if ( ScilabGCXfig_is_initialized == FALSE ) {
    sciprint("xinit must be called before any action \r\n");
    return;
...
void C2F(getcursymbolXfig)(int *verbose, int *symb, int *narg, double *dummy)
{
  *narg =2 ;
...
void C2F(semptyXfig)(int *verbose, int *v2, int *v3, int *v4)
{
  if ( *verbose ==1 ) Scistring("\n No operation ");
}

void C2F(gemptyXfig)(int *verbose, int *v2, int *v3, double *dummy)
{
  if ( *verbose ==1 ) Scistring("\n No operation ");
}
...
void C2F(scilabgcgetXfig)(char *str, int *verbose, int *x1, int *x2, int *x3, int *x4, int *x5, double *dx1, double *dx2, double *dx3, double *dx4)
{
  int x6=0;
  C2F(ScilabGCGetorSetXfig)(str,(int)1L,verbose,x1,x2,x3,x4,x5,&x6,dx1);
}

void C2F(scilabgcsetXfig)(char *str, int *x2, int *x3, int *x4, int *x5, int *x6, int *x7, double *dx1, double *dx2, double *dx3, double *dx4)
{
 int verbose ;
 verbose = 0 ;
 C2F(ScilabGCGetorSetXfig)(str,(int)0L,&verbose,x2,x3,x4,x5,x6,x7,dx1);
}
...
void C2F(displaystringXfig)(char *string, int *x, int *y, int *v1, int *flag, int *v6, int *v7, double *angle, double *dv2, double *dv3, double *dv4)
{    
  int rect[4], font=-1,font_flag=2;
  int verbose=0,Dnarg,Dvalue1[10];
  int pen_color;
...
void C2F(boundingboxXfig)(char *string, int *x, int *y, int *rect, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
...
void C2F(boundingboxXfigM)(char *string, int *x, int *y, int *rect, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{
  int verbose,nargs,font[2];
  verbose=0;
  C2F(xgetfontXfig)(&verbose,font,&nargs,vdouble);
...
void C2F(drawlineXfig)(int *x1, int *yy1, int *x2, int *y2)
{  
  if ( ScilabGCXfig_is_initialized == FALSE ) {
    sciprint("xinit must be called before any action \r\n");
    return;
...
void C2F(drawsegmentsXfig)(char *str, int *vx, int *vy, int *n, int *style, int *iflag, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{
  int NDvalue,i;
  int l_style,style_val,pen_color,fill_color;
  int verbose=0,Dnarg,Dvalue[10],Dvalue1[10];
...
void C2F(drawarrowsXfig)(char *str, int *vx, int *vy, int *n, int *as, int *style, int *iflag, double *dx1, double *dx2, double *dx3, double *dx4)
{
  int i;
  int l_style,style_val,pen_color,fill_color;//areafill;
  int verbose=0,Dnarg,Dvalue[10],Dvalue1[10],NDvalue;
...
void C2F(drawrectangleXfig)(char *str, int *x, int *y, int *width, int *height, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{ 
  int i = 1;
  int fvect[1] ;
  int vects[4];
...
void C2F(fillrectangleXfig)(char *str, int *x, int *y, int *width, int *height, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{ 
  int i = 1;
  int vects[4],verb=0,cpat,num;
...
void C2F(drawrectanglesXfig)(char *str, int *vects, int *fillvect, int *n, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{
  int cpat,verb,num;
  verb=0;
  ...
  C2F(getpatternXfig)(&verb,&cpat,&num,vdouble);
  C2F(WriteGenericXfig)("drawbox",*n,(int)4L,vects,vects,4*(*n),(int)0L,fillvect);
...
void C2F(fillarcsXfig_old)(char *str, int *vects, int *fillvect, int *n, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{
  int cpat,verb,num;
  verb=0;
  ...
  C2F(getpatternXfig)(&verb,&cpat,&num,vdouble);
  C2F(WriteGenericXfig)("drawarc",*n,(int)6L,vects,vects,6*(*n),(int)0L,fillvect);
  C2F(setpatternXfig)(&(cpat),PI0,PI0,PI0);
}

void C2F(fillarcsXfig)(char *str, int *vects, int *fillvect, int *n, int *v5, int *v6, int *v7, double *dv1, double *dv2, double *dv3, double *dv4)
{
...
void C2F(drawarcsXfig_old)(char *str, int *vects, int *style, int *n, int *v5, int *v6, int *v7, double *dv1, double *dv2, double *dv3, double *dv4)
{
  int verbose=0,Dnarg,Dvalue[10];
  /* store the current values */
  ...
  C2F(getdashXfig)(&verbose,Dvalue,&Dnarg,vdouble);
  C2F(WriteGenericXfig)("Rdrawarc",*n,(int)6L,vects,vects,6*(*n),(int)0L,style);
  C2F(setdashXfig)( Dvalue,PI0,PI0,PI0);
}

void C2F(drawarcsXfig)(char *str, int *vects, int *style, int *n, int *v5, int *v6, int *v7, double *dv1, double *dv2, double *dv3, double *dv4)
{
...
void C2F(drawarcXfig_old)(char *str, int *x, int *y, int *width, int *height, int *angle1, int *angle2, double *dx1, double *dx2, double *dx3, double *dx4)
{ 
  int i =1;
  int fvect[1] ;
  int vects[6];
...
void C2F(drawarcXfig)(char *str, int *x, int *y, int *width, int *height, int *angle1, int *angle2, double *dv1, double *dv2, double *dv3, double *dv4)
{ 
  ...
  for (k = 0; k < n; ++k) {
    ...
    vx[k] = (int) (*x + w*(cos(alpha)+1.0));
    vy[k] = (int) (*y + h*(-sin(alpha)+1.0));}
...
void C2F(fillarcXfig_old)(char *str, int *x, int *y, int *width, int *height, int *angle1, int *angle2, double *dx1, double *dx2, double *dx3, double *dx4)
{ 
  int i =1;
  int verb=0,cpat,num ;
  int vects[6];
...
void C2F(fillarcXfig)(char *str, int *x, int *y, int *width, int *height, int *angle1, int *angle2, double *dv1, double *dv2, double *dv3, double *dv4)
{ 
  ...
  if (n != 360) {
  n++;
  vx[n] = (int) (*x + ((*width)/2.0));
  vy[n] = (int) (*y + ((*height)/2.0)); 
  n++;
  }
...
void C2F(drawpolymarkXfig)(char *str, int *n, int *vx, int *vy, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{ 
  int keepid,keepsize,  i=1, sz;
...
static void C2F(displaysymbolsXfig)(char *str, int *n, int *vx, int *vy)
{
  ...
  C2F(WriteGenericXfig)("drawpolymark",(int)1L,(*n)*2,vx,vy,*n,(int)1L,fvect);
...
void C2F(drawpolylinesXfig)(char *str, int *vectsx, int *vectsy, int *drawvect, int *n, int *p, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
...
static BOOL checkPolygon( int *polyX, int *polyY, int length )
{
  if ( length <= 2 )
  {
    return TRUE ;
...
/* for the fig driver we need to know if we have at least three distincts points */
/* for each polygon */
static BOOL checkPolygons( int *polyX, int *polyY, int polyLength, int nbPoly )
{
  int   i                ;
  int * curPolyX = polyX ;
  int * curPolyY = polyY ;
...
void C2F(fillpolylinesXfig)(char *str, int *vectsx, int *vectsy, int *fillvect, int *n, int *p, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{
  int cpat,verb,num;
  verb=0;
  ...
  C2F(getpatternXfig)(&verb,&cpat,&num,vdouble);
  C2F(WriteGenericXfig)("drawpoly",*n,(*p)*2,vectsx,vectsy,(*p)*(*n),(int)1L,
			fillvect);
  C2F(setpatternXfig)(&(cpat),PI0,PI0,PI0);
  FPRINTF((file,"#/absolu true def\n"));
}
...
void C2F(drawpolylineXfig)(char *str, int *n, int *vx, int *vy, int *closeflag, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{ 
  int i=1,fvect=0;
  int *vxtmp = NULL;
  int *vytmp = NULL;
  ...
  if((vxtmp=MALLOC(((*n)+1)*sizeof(int)))==0){
    sciprint("Can not allocate vxtmp while exporting to Fig\n");
    return;
  }
  
  if((vytmp=MALLOC(((*n)+1)*sizeof(int)))==0){
    sciprint("Can not allocate vxtmp while exporting to Fig\n");
    return;
  }
...
void C2F(fillpolylineXfig)(char *str, int *n, int *vx, int *vy, int *closeareaflag, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{
  int i = 1;
  int cpat,verb=0,num;
...
void C2F(initgraphicXfig)(char *string, int *v2, int *v3, int *v4, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{ 
  char string1[50];
...
void C2F(loadfamilyXfig)(char *name, int *j, int *v3, int *v4, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{ 
  int i ;
...
void C2F(queryfamilyXfig)(char *name, int *j, int *v3, int *v4, int *v5, int *v6, int *v7, double *dv1, double *dv2, double *dv3, double *dv4)
{ 
  int i ;
  name[0]='\0';
...
void C2F(drawaxisXfig)(char *str, int *alpha, int *nsteps, int *v2, int *initpoint, int *v6, int *v7, double *size, double *dx2, double *dx3, double *dx4)
{ int i;
...
-----------------------------------------------------*/
void C2F(displaynumbersXfig)(char *str, int *x, int *y, int *v1, int *v2, int *n, int *flag, double *z, double *alpha, double *dx3, double *dx4)
{ int i ;
  char buf[20];
...
static void MyDraw(int iib, int iif, int *vx, int *vy)
{
  int fvect=0,ipoly=1;
  int iideb;
  int x1kn=0,y1kn=0,x2kn=0,y2kn=0;
...
static void C2F(analyze_pointsXfig)(int n, int *vx, int *vy, int onemore)
{ 
...
/* static void C2F(analyze_pointsXfigForFilling)(int n, int *vx, int *vy, int onemore, int cpat) */
/* {  */
/*   int iib,iif,ideb=0,vxl[2],vyl[2],fvect=cpat,ipoly=1,deux=2; */
/*   int xleft, xright, ybot, ytop; */
/*   xleft=ScilabGCXfig.CurClipRegion[0]; */
/*   xright=xleft+ScilabGCXfig.CurClipRegion[2]; */
/*   ybot=ScilabGCXfig.CurClipRegion[1]; */
...
void C2F(initgraphicfromscreenXfig)(char *string, int *v2, int *v3, int *v4, int *v5, int *v6, int *v7, double *dx1, double *dx2, double *dx3, double *dx4)
{
  static int EntryCounter = 0;
  int fnum;
  *v3 = 0;
