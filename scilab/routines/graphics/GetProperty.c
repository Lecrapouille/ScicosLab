...
{ 
  ...
  int v=0;
  double dv=0.0; 
  C2F(dr)("xget","gc",&v,&v,&v,&v,&v,&v,(double *)&gc,&dv,&dv,&dv,5L,10L);
  return gc;
}
...
int version_flag(void) 
{ 
  struct BCG *CurrentScilabXgc = sciGetCurrentScilabXgc();
  return (CurrentScilabXgc == NULL) ?  versionflag 
    : CurrentScilabXgc->graphicsversion;
}
