...
#ifdef WITH_GTK
  strncpy (pFIGURE_FEATURE (pfiguremdl)->name, "ScicosLab Graphic (%d)", sizeof ("ScicosLab Graphic (%d)") + 4);
  pFIGURE_FEATURE (pfiguremdl)->namelen = Min (60, 19+3); 
#else 
  strncpy (pFIGURE_FEATURE (pfiguremdl)->name, "ScicosLab Graphic (%d)", sizeof ("ScicosLab Graphic (%d)") + 4);
  pFIGURE_FEATURE (pfiguremdl)->namelen = Min (60, 19+3); 
#endif 
...
#ifdef WITH_GTK
  strncpy (pFIGURE_FEATURE (pfiguremdl)->name, "ScicosLab Graphic", sizeof ("ScicosLab Graphic") + 4);
  pFIGURE_FEATURE (pfiguremdl)->namelen = Min (sizeof ("ScicosLab Graphic") + 4, 14+3); 
#else 
  strncpy (pFIGURE_FEATURE (pfiguremdl)->name, "ScicosLab Graphic", sizeof ("ScicosLab Graphic") + 4);
  pFIGURE_FEATURE (pfiguremdl)->namelen = Min (sizeof ("ScicosLab Graphic") + 4, 14+3); 
#endif
