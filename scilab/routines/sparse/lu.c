...
#if 0
static int  spSolveCheck(char *eMatrix)
{
  MatrixPtr Matrix = (MatrixPtr) eMatrix;
...
static void 
spLuget(char *eMatrix, int *indP, double *P, int *indl, double *l, int *indu, double *u, int *indQ, double *Q)
{
  int I,J;
  int lsize,usize;
...
void C2F(luget1)(long *fmat,int *indP,double *P,int *indl,
