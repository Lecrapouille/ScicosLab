/*
 * Copyright INRIA 2005  Allan CORNET 
 *
 * References:
 * http://nixdoc.net/man-pages/Tru64/man2/getsysinfo.2.html
 * http://www.opensource.apple.com/darwinsource/projects/
 *          other/gccfast-1621.1/libiberty/physmem.c
...
#define MEMOK 1
  ...
  return (sysconf(_SC_MAPPED_FILES)*sysconf(_SC_PAGESIZE))/kooctet;
#else
