...
c         write(06,*) 'la on est content',kg
      endif
      ...
      lk = lstk(k)
      ilk=iadr(lk)
c      write(06,*) 'on regarde la variable en lk',lk,'fin=',0
c 
...
c     .     indirection to a list entry
 ...
 25   top = top+1
      if (.not.vcopyobj(' ',k,top)) then 
c         write(06,*) 'copy failed from',k,'to',top
         return
      else
c         write(06,*) 'copy ok from',k,'to',top
      endif
c      write(06,*) ' update instk top ',infstk(k)
      infstk(top)=infstk(k)
