...
#define MSG_SCIMSG7 "ScicosLab Communication"
#define MSG_SCIMSG8 "%s -e scipad(getlongpathname('%s')); "
#define MSG_SCIMSG9 "LibScilab"
#define MSG_SCIMSG10 "New ScicosLab"
#define MSG_SCIMSG11 "LIBSCILAB.DLL"
#define MSG_SCIMSG12 "ScicosLab: Printing"
#define MSG_SCIMSG13 "button"
#define MSG_SCIMSG14 "Zoom"
#define MSG_SCIMSG15 "UnZoom"
#define MSG_SCIMSG16 "2D/3D Rotation"
#define MSG_SCIMSG18 "ScicosLab is a free copyrighted software.\n\t"
#define MSG_SCIMSG19 "developed by Scilab Group (Inria/Enpc)\n\t"
#define MSG_SCIMSG20 "\n\t email: scilab@inria.fr\n\t"
#define MSG_SCIMSG21 "ScicosLab"
#define MSG_SCIMSG22 "ScicosLab pause"
#define MSG_SCIMSG23 "ScicosLab Graph"

#define MSG_SCIMSG24 "Wscilex <Options> : run ScicosLab.\n"
#define MSG_SCIMSG24B "scilex <Options> : run ScicosLab.\n"
...
#define MSG_SCIMSG44 "ScicosLab Command Window"
#define MSG_SCIMSG45 "Console ScicosLab"
...
#define MSG_SCIMSG82 "ScicosLab Editor"
...
#define MSG_SCIMSG88 "This software is being provided \"as is\", without any express or implied warranty. In no event will the authors be held liable for any damages arising from, out of or in connection with the software or the use or other dealings in the software.\n\nVeuillez lire le fichier release_notes pour plus de détails."
#define MSG_SCIMSG89 "Ne plus afficher ce message"
#define MSG_SCIMSG90 "This software is being provided \"as is\", without any express or implied warranty. In no event will the authors be held liable for any damages arising from, out of or in connection with the software or the use or other dealings in the software.\n\nPlease read the release_notes file for more details."
...
#define MSG_SCIMSG105 "ScicosLab Document"
...
#define MSG_SCIMSG122 "Arguments : passes Arguments to ScicosLab, This Arguments can be retreived\n  by the ScicosLab function sciargs.\n"
...
#define MSG_SCIMSG131 "-nw : start ScicosLab without specialized ScicosLab Window.\n"
#define MSG_SCIMSG132 "-nwni : start ScicosLab without user interaction (batch mode).\n"
#define MSG_SCIMSG133 "-nogui : start ScicosLab without GUI,tcl/tk and user interaction (batch mode).\n"
