...
SRC_BYT_OBJS=\
 $(SRC_DIR)/linenum.cmo\
 $(SRC_DIR)/stringLexer.cmo\
 $(SRC_DIR)/stringParser.cmo\
 $(SRC_DIR)/modelicaCodeGenerator.cmo\
 $(SRC_DIR)/xMLLexer.cmo\
 $(SRC_DIR)/xMLParser.cmo\
 $(SRC_DIR)/xMLTree.cmo\
 $(SRC_DIR)/xML2Modelica.cmo\

SRC_CAML_FILES=\
 $(SRC_DIR)/modelicaCodeGenerator.mli\
 $(SRC_DIR)/xMLTree.mli\
 $(SRC_BYT_OBJS:.cmo=.ml)\

SRC_CAML_GENERATED_FILES=\
 $(SRC_DIR)/linenum.ml\
 $(SRC_DIR)/stringLexer.ml\
 $(SRC_DIR)/stringParser.mli\
 $(SRC_DIR)/stringParser.ml\
 $(SRC_DIR)/xMLLexer.ml\
 $(SRC_DIR)/xMLParser.mli\
 $(SRC_DIR)/xMLParser.ml\
...
XML2T_CAML_GENERATED_FILES=\
 $(SRC_CAML_GENERATED_FILES)\

XML2T_FILES_TO_BANNERIZE=\
 $(SRC_CAML_FILES)\
