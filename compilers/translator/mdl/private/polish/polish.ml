...
(* $Id: polish.ml 4481 2011-09-16 16:01:33Z weis $ *)
       ...
       | line1 :: lines2 -> 
         let hconc accu elt = 
           let accu_args, accu_ops = polish_exp accu elt in
             accu_args, Transl.string_of_binop Deep_ast.Bhconc :: accu_ops
         in
         let code_line accu line = 
           ( match line with 
             ...
             let accu_args, accu_ops = List.fold_left hconc (accu_args, accu_ops) line2
             in
